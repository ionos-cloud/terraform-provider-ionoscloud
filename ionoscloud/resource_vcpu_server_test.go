		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock", "ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock", "ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerVCPUResource+"."+constant.ServerDataSourceById, "nics.0.ips.*", constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerVCPUResource+"."+constant.ServerDataSourceById, "nics.0.ips.*", constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerVCPUResource+"."+constant.ServerDataSourceByName, "nics.0.ips.*", constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerVCPUResource+"."+constant.ServerDataSourceByName, "nics.0.ips.*", constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock_update", "ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock_update", "ips.1"),
					resource.TestCheckResourceAttr(constant.ServerVCPUResource+"."+constant.ServerTestResource, "nic.0.firewall.0.protocol", "TCP"),
