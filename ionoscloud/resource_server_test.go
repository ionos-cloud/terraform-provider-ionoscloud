		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.id", constant.ServerResource+"."+constant.ServerTestResource, "primary_nic"),
					resource.TestCheckResourceAttr(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.firewall_type", "BIDIRECTIONAL"),
					resource.TestCheckTypeSetElemAttrPair(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock", "ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock", "ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceById, "nics.0.ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceById, "nics.0.ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceByName, "nics.0.ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceByName, "nics.0.ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceById, "nics.0.ipv6_ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ipv6_ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceById, "nics.0.ipv6_ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ipv6_ips.1"),
					resource.TestCheckTypeSetElemAttrPair(constant.DataSource+"."+constant.ServerResource+"."+constant.ServerDataSourceById, "nics.0.ipv6_ips.*", constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ipv6_ips.2"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock_update", "ips.0"),
					resource.TestCheckTypeSetElemAttrPair(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.ips.*", "ionoscloud_ipblock.webserver_ipblock_update", "ips.1"),
					resource.TestCheckResourceAttr(constant.ServerResource+"."+constant.ServerTestResource, "nic.0.firewall.0.protocol", "TCP"),
