...
func (r ApiClustersSharesDeleteRequest) Execute() (*APIResponse, error) {
...
func (a *SharesApiService) ClustersSharesDeleteExecute(r ApiClustersSharesDeleteRequest) (*APIResponse, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"shareId"+"}", _neturl.PathEscape(parameterToString(r.shareId, "")), -1)
...
func (r ApiClustersSharesFindByIdRequest) Execute() (ShareRead, *APIResponse, error) {
...
func (r ApiClustersSharesGetRequest) Execute() (ShareReadList, *APIResponse, error) {
...
func (r ApiClustersSharesPostRequest) Execute() (ShareRead, *APIResponse, error) {
...
func (r ApiClustersSharesPutRequest) Execute() (ShareRead, *APIResponse, error) {
