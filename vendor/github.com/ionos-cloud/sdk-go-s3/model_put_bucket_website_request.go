...
// If the value is explicit nil, the zero value for PutBucketWebsiteRequestWebsiteConfiguration will be returned
...
// HasWebsiteConfiguration returns a boolean if a field has been set.
func (o *PutBucketWebsiteRequest) HasWebsiteConfiguration() bool {
	if o != nil && o.WebsiteConfiguration != nil {
		return true
	}
