...
func (o *POSTObjectRequest) GetXAmzMeta() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *POSTObjectRequest) GetXAmzMetaOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.XAmzMeta) {
		return nil, false
	}
...
func (o *POSTObjectRequest) HasXAmzMeta() bool {
	if o != nil && !IsNil(o.XAmzMeta) {
		return true
	}
...
func (o *POSTObjectRequest) SetXAmzMeta(v map[string]string) {
	o.XAmzMeta = &v
}
