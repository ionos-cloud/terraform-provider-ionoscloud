...
// checks if the GetObjectRetentionOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetObjectRetentionOutput{}
...
// SetRetention gets a reference to the given ObjectLockRetention and assigns it to the Retention field.
...
func (o GetObjectRetentionOutput) ToMap() (map[string]interface{}, error) {
