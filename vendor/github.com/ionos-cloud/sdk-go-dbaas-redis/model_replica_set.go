...
// ReplicaSet Properties with all data needed to create a new Redis replication.
type ReplicaSet struct {
	// The human readable name of your replica set.
	DisplayName *string `json:"displayName"`
	// The RedisDB version of your replica set.
...
func NewReplicaSet(displayName string, redisVersion string, replicas int32, resources Resources, persistenceMode PersistenceMode, evictionPolicy EvictionPolicy, connections []Connection, credentials User) *ReplicaSet {
	this := ReplicaSet{}
...
// GetRedisVersion returns the RedisVersion field value
// If the value is explicit nil, the zero value for string will be returned
func (o *ReplicaSet) GetRedisVersion() *string {
	if o == nil {
		return nil
	}

	return o.RedisVersion

}

// GetRedisVersionOk returns a tuple with the RedisVersion field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ReplicaSet) GetRedisVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}

	return o.RedisVersion, true
}

// SetRedisVersion sets field value
func (o *ReplicaSet) SetRedisVersion(v string) {

	o.RedisVersion = &v

}

// HasRedisVersion returns a boolean if a field has been set.
func (o *ReplicaSet) HasRedisVersion() bool {
	if o != nil && o.RedisVersion != nil {
		return true
	}
...
func (o ReplicaSet) MarshalJSON() ([]byte, error) {
	...
	if o.RedisVersion != nil {
		toSerialize["redisVersion"] = o.RedisVersion
	}
