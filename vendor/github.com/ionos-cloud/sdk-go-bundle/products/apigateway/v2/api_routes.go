...
func (a *RoutesApiService) ApigatewaysRoutesDeleteExecute(r ApiApigatewaysRoutesDeleteRequest) (*shared.APIResponse, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"apigatewayId"+"}", _neturl.PathEscape(parameterValueToString(r.apigatewayId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"routeId"+"}", _neturl.PathEscape(parameterValueToString(r.routeId, "")), -1)
