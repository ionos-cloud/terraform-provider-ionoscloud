...
type PatchNodePoolProperties struct {
	...
	AutoScaling NullableAutoScaling    `json:"autoScaling,omitempty"`
}
...
// SetAutoScaling gets a reference to the given NullableAutoScaling and assigns it to the AutoScaling field.
...
func (o *PatchNodePoolProperties) SetAutoScalingNil() {
