...
// checks if the RequestStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestStatus{}
...
// SetMetadata gets a reference to the given RequestStatusMetadata and assigns it to the Metadata field.
