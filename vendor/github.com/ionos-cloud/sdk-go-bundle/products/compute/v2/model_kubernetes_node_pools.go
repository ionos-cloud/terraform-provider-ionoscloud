...
// checks if the KubernetesNodePools type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesNodePools{}
...
// SetItems gets a reference to the given []KubernetesNodePool and assigns it to the Items field.
