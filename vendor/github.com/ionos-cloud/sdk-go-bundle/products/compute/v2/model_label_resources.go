...
// checks if the LabelResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelResources{}
...
// SetItems gets a reference to the given []LabelResource and assigns it to the Items field.
...
func (o LabelResources) ToMap() (map[string]interface{}, error) {
