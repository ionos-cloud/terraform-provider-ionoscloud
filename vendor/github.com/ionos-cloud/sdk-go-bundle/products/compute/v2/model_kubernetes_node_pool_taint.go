...
// checks if the KubernetesNodePoolTaint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesNodePoolTaint{}
...
func (o KubernetesNodePoolTaint) ToMap() (map[string]interface{}, error) {
