...
// checks if the FirewallRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirewallRules{}
...
// SetItems gets a reference to the given []FirewallRule and assigns it to the Items field.
...
func (o FirewallRules) ToMap() (map[string]interface{}, error) {
