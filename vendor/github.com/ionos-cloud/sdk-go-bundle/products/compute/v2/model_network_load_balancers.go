...
// checks if the NetworkLoadBalancers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkLoadBalancers{}
...
// SetItems gets a reference to the given []NetworkLoadBalancer and assigns it to the Items field.
...
func (o NetworkLoadBalancers) ToMap() (map[string]interface{}, error) {
