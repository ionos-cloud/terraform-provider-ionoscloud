...
// checks if the Lans type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Lans{}
...
// SetItems gets a reference to the given []Lan and assigns it to the Items field.
...
func (o Lans) ToMap() (map[string]interface{}, error) {
