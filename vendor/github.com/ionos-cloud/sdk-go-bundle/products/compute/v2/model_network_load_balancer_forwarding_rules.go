...
// checks if the NetworkLoadBalancerForwardingRules type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkLoadBalancerForwardingRules{}
...
func (o *NetworkLoadBalancerForwardingRules) GetItems() []NetworkLoadBalancerForwardingRule {
	if o == nil || IsNil(o.Items) {
		var ret []NetworkLoadBalancerForwardingRule
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []NetworkLoadBalancerForwardingRule and assigns it to the Items field.
...
func (o NetworkLoadBalancerForwardingRules) ToMap() (map[string]interface{}, error) {
