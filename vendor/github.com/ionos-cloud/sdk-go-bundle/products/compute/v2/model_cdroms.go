...
// checks if the Cdroms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Cdroms{}
...
func (o Cdroms) ToMap() (map[string]interface{}, error) {
