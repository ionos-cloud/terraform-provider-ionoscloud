...
// checks if the Contracts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Contracts{}
...
// SetItems gets a reference to the given []Contract and assigns it to the Items field.
...
func (o Contracts) ToMap() (map[string]interface{}, error) {
