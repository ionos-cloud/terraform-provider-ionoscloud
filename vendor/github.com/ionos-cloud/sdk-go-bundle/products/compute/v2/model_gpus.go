...
// checks if the Gpus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Gpus{}
...
// SetItems gets a reference to the given []Gpu and assigns it to the Items field.
...
func (o Gpus) ToMap() (map[string]interface{}, error) {
