...
// checks if the ArtifactRead type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactRead{}
...
func (o ArtifactRead) ToMap() (map[string]interface{}, error) {
