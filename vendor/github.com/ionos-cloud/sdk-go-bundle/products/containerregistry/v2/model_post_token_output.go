...
// checks if the PostTokenOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostTokenOutput{}
...
func (o PostTokenOutput) ToMap() (map[string]interface{}, error) {
