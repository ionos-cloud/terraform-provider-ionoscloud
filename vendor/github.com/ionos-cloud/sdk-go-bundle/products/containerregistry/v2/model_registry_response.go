...
// checks if the RegistryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryResponse{}
...
func (o RegistryResponse) ToMap() (map[string]interface{}, error) {
