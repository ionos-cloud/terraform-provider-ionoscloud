...
func (r ApiRegistriesRepositoriesFindByNameRequest) Execute() (RepositoryRead, *shared.APIResponse, error) {
 ...
 */
func (a *RepositoriesApiService) RegistriesRepositoriesFindByNameExecute(r ApiRegistriesRepositoriesFindByNameRequest) (RepositoryRead, *shared.APIResponse, error) {
	var (
...
func (r ApiRegistriesRepositoriesGetRequest) Execute() (RepositoryReadList, *shared.APIResponse, error) {
 ...
 */
func (a *RepositoriesApiService) RegistriesRepositoriesGetExecute(r ApiRegistriesRepositoriesGetRequest) (RepositoryReadList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	if r.filterVulnerabilitySeverity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "filter.vulnerabilitySeverity", r.filterVulnerabilitySeverity, "")
	}
	if r.orderBy != nil {
