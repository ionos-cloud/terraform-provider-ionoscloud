...
func (r ApiAutoCertificatesDeleteRequest) Execute() (*shared.APIResponse, error) {
...
func (a *AutoCertificateApiService) AutoCertificatesDeleteExecute(r ApiAutoCertificatesDeleteRequest) (*shared.APIResponse, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"autoCertificateId"+"}", _neturl.PathEscape(parameterValueToString(r.autoCertificateId, "")), -1)
...
func (r ApiAutoCertificatesFindByIdRequest) Execute() (AutoCertificateRead, *shared.APIResponse, error) {
 ...
 */
func (a *AutoCertificateApiService) AutoCertificatesFindByIdExecute(r ApiAutoCertificatesFindByIdRequest) (AutoCertificateRead, *shared.APIResponse, error) {
	var (
...
func (r ApiAutoCertificatesGetRequest) Execute() (AutoCertificateReadList, *shared.APIResponse, error) {
 ...
 */
func (a *AutoCertificateApiService) AutoCertificatesGetExecute(r ApiAutoCertificatesGetRequest) (AutoCertificateReadList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiAutoCertificatesPatchRequest) Execute() (AutoCertificateRead, *shared.APIResponse, error) {
 ...
 * @return AutoCertificateRead
 */
func (a *AutoCertificateApiService) AutoCertificatesPatchExecute(r ApiAutoCertificatesPatchRequest) (AutoCertificateRead, *shared.APIResponse, error) {
	var (
...
func (r ApiAutoCertificatesPostRequest) Execute() (AutoCertificateRead, *shared.APIResponse, error) {
 ...
 * @return AutoCertificateRead
 */
func (a *AutoCertificateApiService) AutoCertificatesPostExecute(r ApiAutoCertificatesPostRequest) (AutoCertificateRead, *shared.APIResponse, error) {
	var (
