...
func (r ApiVersionsGetRequest) Execute() (MongoDBVersionList, *shared.APIResponse, error) {
	return r.ApiService.VersionsGetExecute(r)
}

/*
 * VersionsGet Get available MongoDB versions
 ...
 */
func (a *MetadataApiService) VersionsGetExecute(r ApiVersionsGetRequest) (MongoDBVersionList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
