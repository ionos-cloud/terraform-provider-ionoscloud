...
// checks if the ReplicaSetReadList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaSetReadList{}
...
func (o ReplicaSetReadList) ToMap() (map[string]interface{}, error) {
...
type NullableReplicaSetReadList struct {
	value *ReplicaSetReadList
	isSet bool
}

func (v NullableReplicaSetReadList) Get() *ReplicaSetReadList {
	return v.value
}

func (v *NullableReplicaSetReadList) Set(val *ReplicaSetReadList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReplicaSetReadList(val *ReplicaSetReadList) *NullableReplicaSetReadList {
	return &NullableReplicaSetReadList{value: val, isSet: true}
}
