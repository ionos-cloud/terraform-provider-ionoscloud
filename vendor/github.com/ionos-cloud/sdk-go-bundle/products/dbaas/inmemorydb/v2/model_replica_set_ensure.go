...
// checks if the ReplicaSetEnsure type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaSetEnsure{}
...
func (o ReplicaSetEnsure) ToMap() (map[string]interface{}, error) {
