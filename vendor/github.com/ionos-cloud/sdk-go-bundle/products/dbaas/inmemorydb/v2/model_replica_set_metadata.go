...
// checks if the ReplicaSetMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaSetMetadata{}
...
func (o ReplicaSetMetadata) ToMap() (map[string]interface{}, error) {
