 ...
 * @return SnapshotRead
 */
func (a *SnapshotApiService) SnapshotsFindByIdExecute(r ApiSnapshotsFindByIdRequest) (SnapshotRead, *shared.APIResponse, error) {
	var (
 ...
 */
func (a *SnapshotApiService) SnapshotsGetExecute(r ApiSnapshotsGetRequest) (SnapshotReadList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
