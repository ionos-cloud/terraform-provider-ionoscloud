...
// APIClient manages communication with the IONOS CLOUD DBaaS In-Memory DB API v2.0.0
...
type APIClient struct {
	...
	SnapshotLocationsApi *SnapshotLocationsApiService
	...
	*cfgCopy = *cfg
	...
	if len(cfgCopy.Servers) == 0 {
		cfgCopy.Servers = shared.ServerConfigurations{
			{
				URL:         "https://in-memory-db.de-fra.ionos.com/v2",
				Description: "Germany, Frankfurt",
			},
			{
				URL:         "https://in-memory-db.de-txl.ionos.com/v2",
				Description: "Germany, Berlin",
			},
			{
				URL:         "https://in-memory-db.es-vit.ionos.com/v2",
				Description: "Spain, Logroño",
			},
			{
				URL:         "https://in-memory-db.gb-bhx.ionos.com/v2",
				Description: "United Kingdom, Worcester",
			},
			{
				URL:         "https://in-memory-db.gb-lhr.ionos.com/v2",
				Description: "United Kingdom, London",
			},
			{
				URL:         "https://in-memory-db.us-ewr.ionos.com/v2",
				Description: "United States, Newark",
			},
			{
				URL:         "https://in-memory-db.us-las.ionos.com/v2",
				Description: "United States, Las Vegas",
			},
			{
				URL:         "https://in-memory-db.us-mci.ionos.com/v2",
				Description: "United States, Lenexa",
			},
			{
				URL:         "https://in-memory-db.fr-par.ionos.com/v2",
	...
	c.SnapshotLocationsApi = (*SnapshotLocationsApiService)(&c.common)
