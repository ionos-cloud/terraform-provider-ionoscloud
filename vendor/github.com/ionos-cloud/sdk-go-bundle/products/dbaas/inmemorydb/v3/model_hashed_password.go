...
// HashedPassword A pre-hashed password for the user.
type HashedPassword struct {
	Algorithm string `json:"algorithm"`
	// The hex-encoded hash of the password. Must be exactly 64 lowercase hexadecimal characters (the standard output of SHA-256). Note: base64-encoded SHA-256 hashes (44 characters) are not accepted.
