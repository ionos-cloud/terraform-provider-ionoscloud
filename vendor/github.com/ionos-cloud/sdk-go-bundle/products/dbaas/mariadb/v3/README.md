...
```bash
go get github.com/ionos-cloud/sdk-go-bundle/products/mariadb.git
```
To update the SDK use go get -u to retrieve the latest version of the SDK.
```bash
go get -u github.com/ionos-cloud/sdk-go-bundle/products/mariadb.git
```
### Go Modules
...
```bash
go get github.com/ionos-cloud/sdk-go-bundle/products/mariadb@latest
```
