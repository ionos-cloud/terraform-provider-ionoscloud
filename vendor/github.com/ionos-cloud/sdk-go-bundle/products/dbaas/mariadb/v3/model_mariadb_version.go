...
type MariadbVersion struct {
	...
	// List of versions that a cluster running this version can be upgraded to. Only versions in this list are accepted when updating the version field via PUT.
