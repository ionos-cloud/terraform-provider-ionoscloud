...
// Cluster Create, manage, and monitor MariaDB clusters through the IONOS CLOUD API.
type Cluster struct {
	...
	Credentials       *MariadbUser                     `json:"credentials,omitempty"`
...
// SetCredentials gets a reference to the given MariadbUser and assigns it to the Credentials field.
