...
type ClusterCreateProperties struct {
	// The name of your MariaDB cluster. Must be 63 characters or less and must begin and end with an alphanumeric character (`[a-z0-9A-Z]`) with dashes (`-`), underscores (`_`), dots (`.`), and alphanumerics between.
	Name string `json:"name"`
	// Human-readable description for the cluster.
	Description *string `json:"description,omitempty"`
	// The MariaDB version for the cluster. Use GET /versions to retrieve the list of supported versions. To upgrade, provide a version listed in canUpgradeTo for the current version. Downgrades are not supported.
	Version           string                           `json:"version"`
	Instances         InstanceConfiguration            `json:"instances"`
	Connection        MariadbClusterConnection         `json:"connection"`
	MaintenanceWindow MaintenanceWindow                `json:"maintenanceWindow"`
	Credentials       MariadbUser                      `json:"credentials"`
	RestoreFromBackup *MariadbRestoreClusterFromBackup `json:"restoreFromBackup,omitempty"`
...
func (o *ClusterCreateProperties) GetConnection() MariadbClusterConnection {
	if o == nil {
		var ret MariadbClusterConnection
		return ret
	}
...
func (o *ClusterCreateProperties) GetRestoreFromBackup() MariadbRestoreClusterFromBackup {
	if o == nil || IsNil(o.RestoreFromBackup) {
		var ret MariadbRestoreClusterFromBackup
		return ret
	}
...
// SetRestoreFromBackup gets a reference to the given MariadbRestoreClusterFromBackup and assigns it to the RestoreFromBackup field.
