...
func NewBucketPolicyStatementPrincipalAnyOf() *BucketPolicyStatementPrincipalAnyOf {
...
// GetCanonicalUser returns the CanonicalUser field value if set, zero value otherwise.
func (o *BucketPolicyStatementPrincipalAnyOf) GetCanonicalUser() []string {
	if o == nil || IsNil(o.CanonicalUser) {
		var ret []string
		return ret
	}
	return o.CanonicalUser
}

// GetCanonicalUserOk returns a tuple with the CanonicalUser field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BucketPolicyStatementPrincipalAnyOf) GetCanonicalUserOk() ([]string, bool) {
	if o == nil || IsNil(o.CanonicalUser) {
		return nil, false
	}
	return o.CanonicalUser, true
}

// HasCanonicalUser returns a boolean if a field has been set.
func (o *BucketPolicyStatementPrincipalAnyOf) HasCanonicalUser() bool {
	if o != nil && !IsNil(o.CanonicalUser) {
		return true
	}
...
// SetCanonicalUser gets a reference to the given []string and assigns it to the CanonicalUser field.
func (o *BucketPolicyStatementPrincipalAnyOf) SetCanonicalUser(v []string) {
	o.CanonicalUser = v
}
...
func (o BucketPolicyStatementPrincipalAnyOf) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CanonicalUser) {
		toSerialize["CanonicalUser"] = o.CanonicalUser
	}
