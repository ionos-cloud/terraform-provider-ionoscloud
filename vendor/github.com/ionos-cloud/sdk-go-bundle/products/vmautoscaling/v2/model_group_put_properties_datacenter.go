...
// checks if the GroupPutPropertiesDatacenter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPutPropertiesDatacenter{}
...
func (o GroupPutPropertiesDatacenter) ToMap() (map[string]interface{}, error) {
