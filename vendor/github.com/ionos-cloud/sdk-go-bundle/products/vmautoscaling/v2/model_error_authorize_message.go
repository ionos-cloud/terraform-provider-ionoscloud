...
// checks if the ErrorAuthorizeMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorAuthorizeMessage{}
...
func (o ErrorAuthorizeMessage) ToMap() (map[string]interface{}, error) {
