...
func (r ApiGroupsActionsFindByIdRequest) Execute() (Action, *shared.APIResponse, error) {
 ...
 * @return Action
 */
func (a *AutoScalingGroupsApiService) GroupsActionsFindByIdExecute(r ApiGroupsActionsFindByIdRequest) (Action, *shared.APIResponse, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"actionId"+"}", _neturl.PathEscape(parameterValueToString(r.actionId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"groupId"+"}", _neturl.PathEscape(parameterValueToString(r.groupId, "")), -1)
...
func (r ApiGroupsActionsGetRequest) Execute() (ActionCollection, *shared.APIResponse, error) {
 ...
 */
func (a *AutoScalingGroupsApiService) GroupsActionsGetExecute(r ApiGroupsActionsGetRequest) (ActionCollection, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGroupsDeleteRequest) Execute() (*shared.APIResponse, error) {
 ...
 * Execute executes the request
 */
func (a *AutoScalingGroupsApiService) GroupsDeleteExecute(r ApiGroupsDeleteRequest) (*shared.APIResponse, error) {
	var (
...
func (r ApiGroupsFindByIdRequest) Execute() (Group, *shared.APIResponse, error) {
 ...
 * @return Group
 */
func (a *AutoScalingGroupsApiService) GroupsFindByIdExecute(r ApiGroupsFindByIdRequest) (Group, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGroupsGetRequest) Execute() (GroupCollection, *shared.APIResponse, error) {
 ...
 */
func (a *AutoScalingGroupsApiService) GroupsGetExecute(r ApiGroupsGetRequest) (GroupCollection, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGroupsPostRequest) Execute() (GroupPostResponse, *shared.APIResponse, error) {
 ...
 */
func (a *AutoScalingGroupsApiService) GroupsPostExecute(r ApiGroupsPostRequest) (GroupPostResponse, *shared.APIResponse, error) {
	var (
...
func (r ApiGroupsPutRequest) Execute() (Group, *shared.APIResponse, error) {
 ...
 * @return Group
 */
func (a *AutoScalingGroupsApiService) GroupsPutExecute(r ApiGroupsPutRequest) (Group, *shared.APIResponse, error) {
	var (
...
func (r ApiGroupsServersFindByIdRequest) Execute() (Server, *shared.APIResponse, error) {
 ...
 * @return Server
 */
func (a *AutoScalingGroupsApiService) GroupsServersFindByIdExecute(r ApiGroupsServersFindByIdRequest) (Server, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGroupsServersGetRequest) Execute() (ServerCollection, *shared.APIResponse, error) {
 ...
 */
func (a *AutoScalingGroupsApiService) GroupsServersGetExecute(r ApiGroupsServersGetRequest) (ServerCollection, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
