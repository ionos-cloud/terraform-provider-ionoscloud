...
// checks if the GroupPolicyScaleOutAction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPolicyScaleOutAction{}
...
func (o GroupPolicyScaleOutAction) ToMap() (map[string]interface{}, error) {
