...
// checks if the ServerCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerCollection{}
...
func (o ServerCollection) ToMap() (map[string]interface{}, error) {
