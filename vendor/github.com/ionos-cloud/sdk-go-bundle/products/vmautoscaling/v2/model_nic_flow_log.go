...
// checks if the NicFlowLog type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NicFlowLog{}
...
func (o NicFlowLog) ToMap() (map[string]interface{}, error) {
