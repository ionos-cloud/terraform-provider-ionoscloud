...
// checks if the GroupPropertiesDatacenter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupPropertiesDatacenter{}
...
func (o GroupPropertiesDatacenter) ToMap() (map[string]interface{}, error) {
