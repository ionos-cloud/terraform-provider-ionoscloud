...
*/
func (a *BackupServiceApiService) BackupunitsDelete(ctx _context.Context, backupunitId string) ApiBackupunitsDeleteRequest {
	return ApiBackupunitsDeleteRequest{
		ApiService:   a,
		ctx:          ctx,
 ...
 */
func (a *BackupServiceApiService) BackupunitsDeleteExecute(r ApiBackupunitsDeleteRequest) (*shared.APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsDelete")
	if err != nil {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"backupunitId"+"}", _neturl.PathEscape(parameterValueToString(r.backupunitId, "")), -1)
 ...
 */
func (a *BackupServiceApiService) BackupunitsFindById(ctx _context.Context, backupunitId string) ApiBackupunitsFindByIdRequest {
	return ApiBackupunitsFindByIdRequest{
		ApiService:   a,
		ctx:          ctx,
		backupunitId: backupunitId,
 ...
 * @return BackupUnit
 */
func (a *BackupServiceApiService) BackupunitsFindByIdExecute(r ApiBackupunitsFindByIdRequest) (BackupUnit, *shared.APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsFindById")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
 ...
 * @return BackupUnits
 */
func (a *BackupServiceApiService) BackupunitsGetExecute(r ApiBackupunitsGetRequest) (BackupUnits, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsGet")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
		return localVarReturnValue, nil, gerr
 ...
 */
func (a *BackupServiceApiService) BackupunitsPatch(ctx _context.Context, backupunitId string) ApiBackupunitsPatchRequest {
	return ApiBackupunitsPatchRequest{
		ApiService:   a,
		ctx:          ctx,
		backupunitId: backupunitId,
 ...
 * @return BackupUnit
 */
func (a *BackupServiceApiService) BackupunitsPatchExecute(r ApiBackupunitsPatchRequest) (BackupUnit, *shared.APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsPatch")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
		return localVarReturnValue, nil, gerr
 ...
 */
func (a *BackupServiceApiService) BackupunitsPost(ctx _context.Context) ApiBackupunitsPostRequest {
	return ApiBackupunitsPostRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 * @return BackupUnit
 */
func (a *BackupServiceApiService) BackupunitsPostExecute(r ApiBackupunitsPostRequest) (BackupUnit, *shared.APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsPost")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
		return localVarReturnValue, nil, gerr
 ...
 */
func (a *BackupServiceApiService) BackupunitsPut(ctx _context.Context, backupunitId string) ApiBackupunitsPutRequest {
	return ApiBackupunitsPutRequest{
		ApiService:   a,
		ctx:          ctx,
		backupunitId: backupunitId,
 ...
 * @return BackupUnit
 */
func (a *BackupServiceApiService) BackupunitsPutExecute(r ApiBackupunitsPutRequest) (BackupUnit, *shared.APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsPut")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
		return localVarReturnValue, nil, gerr
 ...
 */
func (a *BackupServiceApiService) BackupunitsSsourlGet(ctx _context.Context, backupunitId string) ApiBackupunitsSsourlGetRequest {
	return ApiBackupunitsSsourlGetRequest{
		ApiService:   a,
		ctx:          ctx,
		backupunitId: backupunitId,
 ...
 */
func (a *BackupServiceApiService) BackupunitsSsourlGetExecute(r ApiBackupunitsSsourlGetRequest) (BackupUnitSSO, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupServiceApiService.BackupunitsSsourlGet")
	if err != nil {
		gerr := shared.GenericOpenAPIError{}
		gerr.SetError(err.Error())
		return localVarReturnValue, nil, gerr
