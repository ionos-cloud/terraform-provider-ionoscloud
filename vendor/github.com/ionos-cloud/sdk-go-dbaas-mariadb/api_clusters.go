...
*/
func (a *ClustersApiService) ClustersRestore(ctx _context.Context, clusterId string) ApiClustersRestoreRequest {
	return ApiClustersRestoreRequest{
		ApiService: a,
		ctx:        ctx,
		clusterId:  clusterId,
 ...
 * Execute executes the request
 */
func (a *ClustersApiService) ClustersRestoreExecute(r ApiClustersRestoreRequest) (*APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ClustersApiService.ClustersRestore")
	if err != nil {
