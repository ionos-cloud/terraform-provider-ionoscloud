...
// Server Links a Datacenter Server to a Autoscaling Group. Note, that this entities UUID is different from that of the Datacenter Server, whose UUID is stored in the `datacenterServer` property.
type Server struct {
...
func (o *Server) GetEntities() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Server) GetEntitiesOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Server) SetEntities(v map[string]interface{}) {
