...
// ServerAllOf Links a data center server to an autoscaling group. Please note that this entities UUID is different from that of the data center server, whose UUID is stored in the `datacenterServer` property.
type ServerAllOf struct {
...
func (o ServerAllOf) MarshalJSON() ([]byte, error) {
...
type NullableServerAllOf struct {
	value *ServerAllOf
	isSet bool
}

func (v NullableServerAllOf) Get() *ServerAllOf {
	return v.value
}

func (v *NullableServerAllOf) Set(val *ServerAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServerAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServerAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerAllOf(val *ServerAllOf) *NullableServerAllOf {
	return &NullableServerAllOf{value: val, isSet: true}
}

func (v NullableServerAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
