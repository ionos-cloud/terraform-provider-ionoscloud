...
type ApiNamesFindByNameRequest struct {
	ctx        _context.Context
	ApiService *NamesApiService
	name       string
}

func (r ApiNamesFindByNameRequest) Execute() (*APIResponse, error) {
	return r.ApiService.NamesFindByNameExecute(r)
}

/*
 * NamesFindByName Get container registry name availability
 ...
 */
func (a *NamesApiService) NamesFindByNameExecute(r ApiNamesFindByNameRequest) (*APIResponse, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NamesApiService.NamesFindByName")
	if err != nil {
