...
func (o *GroupAllOf) GetEntities() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GroupAllOf) GetEntitiesOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GroupAllOf) SetEntities(v map[string]interface{}) {
