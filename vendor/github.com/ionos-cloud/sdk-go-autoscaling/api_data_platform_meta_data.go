...
func (r ApiVersionsGetRequest) Execute() ([]string, *APIResponse, error) {
	return r.ApiService.VersionsGetExecute(r)
}

/*
 * VersionsGet Managed Data Stack API version
 * Retrieves all available versions of the Managed Data Stack Solution.
 ...
 * @return []string
 */
func (a *DataPlatformMetaDataApiService) VersionsGetExecute(r ApiVersionsGetRequest) ([]string, *APIResponse, error) {
	var (
