...
func (o *ServerCollection) GetId() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
func (o *ServerCollection) GetIdOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServerCollection) SetId(v map[string]interface{}) {
...
// If the value is explicit nil, the zero value for map[string]interface{} will be returned
func (o *ServerCollection) GetType() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerCollection) GetTypeOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServerCollection) SetType(v map[string]interface{}) {
...
// If the value is explicit nil, the zero value for map[string]interface{} will be returned
func (o *ServerCollection) GetHref() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerCollection) GetHrefOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServerCollection) SetHref(v map[string]interface{}) {
...
// If the value is explicit nil, the zero value for map[string]interface{} will be returned
func (o *ServerCollection) GetItems() *map[string]interface{} {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ServerCollection) GetItemsOk() (*map[string]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ServerCollection) SetItems(v map[string]interface{}) {
