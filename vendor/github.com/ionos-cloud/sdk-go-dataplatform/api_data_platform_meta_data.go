...
func (r ApiVersionsGetRequest) Execute() (VersionsGet200Response, *APIResponse, error) {
 ...
 */
func (a *DataPlatformMetaDataApiService) VersionsGetExecute(r ApiVersionsGetRequest) (VersionsGet200Response, *APIResponse, error) {
	var (
