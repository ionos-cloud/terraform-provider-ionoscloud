...
func (r ApiClustersNodepoolsDeleteRequest) Execute() (NodePoolResponseData, *APIResponse, error) {
 ...
 */
func (a *DataPlatformNodePoolApiService) ClustersNodepoolsDeleteExecute(r ApiClustersNodepoolsDeleteRequest) (NodePoolResponseData, *APIResponse, error) {
	var (
...
func (r ApiClustersNodepoolsFindByIdRequest) Execute() (NodePoolResponseData, *APIResponse, error) {
 ...
 * @return NodePoolResponseData
 */
func (a *DataPlatformNodePoolApiService) ClustersNodepoolsFindByIdExecute(r ApiClustersNodepoolsFindByIdRequest) (NodePoolResponseData, *APIResponse, error) {
	var (
...
func (r ApiClustersNodepoolsGetRequest) Execute() (NodePoolListResponseData, *APIResponse, error) {
 ...
 */
func (a *DataPlatformNodePoolApiService) ClustersNodepoolsGetExecute(r ApiClustersNodepoolsGetRequest) (NodePoolListResponseData, *APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiClustersNodepoolsPatchRequest) Execute() (NodePoolResponseData, *APIResponse, error) {
 ...
 * @return NodePoolResponseData
 */
func (a *DataPlatformNodePoolApiService) ClustersNodepoolsPatchExecute(r ApiClustersNodepoolsPatchRequest) (NodePoolResponseData, *APIResponse, error) {
	var (
...
func (r ApiClustersNodepoolsPostRequest) Execute() (NodePoolResponseData, *APIResponse, error) {
 ...
 * @return NodePoolResponseData
 */
func (a *DataPlatformNodePoolApiService) ClustersNodepoolsPostExecute(r ApiClustersNodepoolsPostRequest) (NodePoolResponseData, *APIResponse, error) {
	var (
