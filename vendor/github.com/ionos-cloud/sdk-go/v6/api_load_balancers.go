...
func (r ApiDatacentersLoadbalancersBalancednicsFindByNicIdRequest) Offset(offset int32) ApiDatacentersLoadbalancersBalancednicsFindByNicIdRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersLoadbalancersBalancednicsFindByNicIdRequest) Limit(limit int32) ApiDatacentersLoadbalancersBalancednicsFindByNicIdRequest {
	r.limit = &limit
	return r
}
...
func (r ApiDatacentersLoadbalancersDeleteRequest) Offset(offset int32) ApiDatacentersLoadbalancersDeleteRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersLoadbalancersDeleteRequest) Limit(limit int32) ApiDatacentersLoadbalancersDeleteRequest {
	r.limit = &limit
	return r
}
