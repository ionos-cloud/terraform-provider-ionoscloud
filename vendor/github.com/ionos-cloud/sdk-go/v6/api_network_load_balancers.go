...
func (r ApiDatacentersNetworkloadbalancersPutRequest) Offset(offset int32) ApiDatacentersNetworkloadbalancersPutRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersNetworkloadbalancersPutRequest) Limit(limit int32) ApiDatacentersNetworkloadbalancersPutRequest {
	r.limit = &limit
	return r
}
