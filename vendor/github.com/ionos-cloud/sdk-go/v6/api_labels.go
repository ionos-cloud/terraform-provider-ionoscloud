...
func (r ApiDatacentersLabelsFindByKeyRequest) Offset(offset int32) ApiDatacentersLabelsFindByKeyRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersLabelsFindByKeyRequest) Limit(limit int32) ApiDatacentersLabelsFindByKeyRequest {
	r.limit = &limit
	return r
}
...
func (r ApiDatacentersServersLabelsPutRequest) Offset(offset int32) ApiDatacentersServersLabelsPutRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersServersLabelsPutRequest) Limit(limit int32) ApiDatacentersServersLabelsPutRequest {
	r.limit = &limit
	return r
}
