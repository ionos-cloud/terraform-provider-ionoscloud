## 6.7.12
### Changes
- No longer add `boot_volume` in the `inlune_volume_ids` list on server and vcpu_server imports as it generated errors when using `ionoscloud_server_boot_device_selection` with a server with on boot device
### Fixes
