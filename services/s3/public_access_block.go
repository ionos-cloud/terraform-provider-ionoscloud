...
func buildPublicAccessBlockFromModel(model *BucketPublicAccessBlockResourceModel) s3.BlockPublicAccessPayload {
...
func buildPublicAccessBlockModelFromAPIResponse(output *s3.BlockPublicAccessOutput, model *BucketPublicAccessBlockResourceModel) *BucketPublicAccessBlockResourceModel {
