...
func (c *Client) setObjectCopyComputedAttributes(ctx context.Context, data *ObjectCopyResourceModel, apiResponse *s3.APIResponse, output *s3.CopyObjectResult) error {
...
func deleteObjectCopyByModel(ctx context.Context, client *s3.APIClient, data *ObjectCopyResourceModel) (map[string]interface{}, *s3.APIResponse, error) {
...
func (c *Client) setObjectCopyCommonAttributes(ctx context.Context, data *ObjectCopyResourceModel, apiResponse *s3.APIResponse) error {
...
func setObjectCopyObjectLockData(data *ObjectCopyResourceModel, apiResponse *s3.APIResponse) error {
