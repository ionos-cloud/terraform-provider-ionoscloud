...
func (c *Client) UpdateBucketPolicy(ctx context.Context, data *BucketPolicyModel) error {
	...
	if !found {
		return fmt.Errorf("bucket policy not found")
	}
...
func (c *Client) GetBucketPolicyCheck(ctx context.Context, bucketName string) (*s3.BucketPolicy, error) {
...
func buildBucketPolicyFromModel(policyModel *BucketPolicyModel) (s3.BucketPolicy, diag.Diagnostics) {
	var diags diag.Diagnostics
