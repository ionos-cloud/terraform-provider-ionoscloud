...
func (c *Client) setObjectDataSourceModelData(ctx context.Context, apiResponse *s3.APIResponse, data *ObjectDataSourceModel) error {
...
func (c *Client) setObjectDataSourceCommonAttributes(ctx context.Context, data *ObjectDataSourceModel, apiResponse *s3.APIResponse) error {
...
func setObjectDataSourceContentData(data *ObjectDataSourceModel, apiResponse *s3.APIResponse) {
...
func setObjectDataSourceServerSideEncryptionData(data *ObjectDataSourceModel, apiResponse *s3.APIResponse) {
...
func setObjectDataSourceObjectLockData(data *ObjectDataSourceModel, apiResponse *s3.APIResponse) error {
