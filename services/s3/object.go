...
func (c *Client) UploadObject(ctx context.Context, data *ObjectResourceModel) (*s3.APIResponse, error) {
...
func (c *Client) SetObjectComputedAttributes(ctx context.Context, data *ObjectResourceModel, apiResponse *s3.APIResponse) error {
...
func (c *Client) putRetention(ctx context.Context, plan, state *ObjectResourceModel) (*s3.APIResponse, error) {
...
func (c *Client) setObjectCommonAttributes(ctx context.Context, data *ObjectResourceModel, apiResponse *s3.APIResponse) error {
...
func (c *Client) setObjectModelData(ctx context.Context, apiResponse *s3.APIResponse, data *ObjectResourceModel) error {
...
func (c *Client) findObject(ctx context.Context, data *objectFindRequest) (*s3.HeadObjectOutput, *s3.APIResponse, error) {
...
func getMetadataFromAPIResponse(ctx context.Context, apiResponse *s3.APIResponse) (types.Map, error) {
...
func deleteObjectByModel(ctx context.Context, client *s3.APIClient, data *ObjectResourceModel) (map[string]interface{}, *s3.APIResponse, error) {
