...
func (c *Client) GetAPIGatewayByID(ctx context.Context, id string) (apigateway.GatewayRead, *shared.APIResponse, error) {
...
func (c *Client) ListAPIGateways(ctx context.Context) (apigateway.GatewayReadList, *shared.APIResponse, error) {
...
func (c *Client) DeleteAPIGateway(ctx context.Context, id string) (*shared.APIResponse, error) {
...
func (c *Client) UpdateAPIGateway(ctx context.Context, d *schema.ResourceData) (apigateway.GatewayRead, *shared.APIResponse, error) {
...
func (c *Client) CreateAPIGateway(ctx context.Context, d *schema.ResourceData) (apigateway.GatewayRead, *shared.APIResponse, error) {
...
func setGatewayConfig(d *schema.ResourceData) apigateway.Gateway {
	...
	for i, domain := range customDomainsRaw {
		...
		if cert, ok := domainData["certificate_id"]; ok && cert != "" {
			customDomainObj.CertificateId = shared.ToPtr(cert.(string))
		}
	...
	return apigateway.Gateway{
		Name:          gatewayName,
		Logs:          shared.ToPtr(logs),
		Metrics:       shared.ToPtr(metrics),
