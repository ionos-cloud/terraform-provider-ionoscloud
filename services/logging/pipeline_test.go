...
//func TestClientConfigurationFlow(t *testing.T) {
...
//	}
//
//	client := NewClient(clientOptions, loadedConfig)
//
//	// Step 2: Override the client configuration from the loaded config
//	loadedconfig.overrideClientEndpoint(client, shared.Logging, "de/fra")
//
//	// Verify the override worked
//	assert.Equal(t, "https://override.logging.de-fra.ionos.com", client.GetConfig().Servers[0].URL)
//
//	// Step 3: Change the config URL using ChangeConfigURL
//	client.ChangeConfigURL("de/fra")
//
//	// Verify the final URL after change
//	assert.Equal(t, "https://logging.de-fra.ionos.com", client.GetConfig().Servers[0].URL)
//
//	// Test changing the config URL with environment variable
//	os.Setenv("IONOS_API_URL_LOGGING", "https://env.endpoint.com")
//	client.ChangeConfigURL("")
//	assert.Equal(t, "https://env.endpoint.com", client.GetConfig().Servers[0].URL)
