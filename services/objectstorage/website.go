...
func buildBucketWebsiteConfigurationModelFromAPIResponse(output *objstorage.GetBucketWebsiteOutput, bucket types.String) *BucketWebsiteConfigurationModel {
...
func buildBucketWebsiteConfigurationFromModel(data *BucketWebsiteConfigurationModel) objstorage.PutBucketWebsiteRequest {
	return objstorage.PutBucketWebsiteRequest{
...
func buildIndexDocumentFromModel(data *indexDocument) *objstorage.IndexDocument {
	if data == nil {
		return nil
	}
...
func buildErrorDocumentFromModel(data *errorDocument) *objstorage.ErrorDocument {
	if data == nil {
		return nil
	}
...
func buildRedirectAllRequestsToFromModel(data *redirectAllRequestsTo) *objstorage.RedirectAllRequestsTo {
	if data == nil {
		return nil
	}
...
func buildRoutingRulesFromModel(data []routingRule) *[]objstorage.RoutingRule {
	...
	rules := make([]objstorage.RoutingRule, 0, len(data))
	for _, r := range data {
		var rl objstorage.RoutingRule
		if r.Condition != nil {
			rl.Condition = &objstorage.RoutingRuleCondition{
