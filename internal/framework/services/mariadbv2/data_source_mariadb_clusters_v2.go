...
// NewClustersDataSource creates a new data source for listing MariaDB v2 clusters.
...
func (d *clustersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mariadb_clusters_v2"
}
...
func (d *clustersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Lists all IONOS CLOUD MariaDB V2 clusters in a given location, with optional name filter.",
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				Optional:    true,
				Description: "Filter clusters by name (partial match).",
			},
		},
	}
}
...
func (d *clustersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	list, apiResponse, err := client.ListClusters(ctx, data.Name.ValueString())
	if err != nil {
